...
import pygame
import numpy as np
from models.nagent import Denoiser
...
if __name__ == "__main__":
    ...
    model_weight_path = "/home/monsh/works/image/madx/madx/weights/test-030000.pt"
    use_vae = True
    ...
    sampler = DiffusionSampler(denoiser=denoiser, cfg=DiffusionSamplerConfig(num_steps_denoising=3))
    ...
    while running and env.agents:
        ...
        # print("prev_actions", act.shape, act.dtype)
        print("prev_actions", act)
